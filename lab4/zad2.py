...
class Library:
    ...
    def __str__(self) -> str:
        return f'Library is located in {self.city} (zip code {self.zip_code}) \
            on the street {self.street}. Open houers {self.open_hours}, \
...
class Book:
    ...
    def __str__(self) -> str:
        return f'Book is located in library: {self.library}. \
